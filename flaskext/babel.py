...
class Babel(object):
    ...
    def init_app(self, app):
        ...
        app.config.setdefault('BABEL_TRANSLATIONS_DIR', self._translations_dir)
    ...
    def list_translations(self):
        ...
        dirname = os.path.join(
            self.app.root_path,
            self.app.config['BABEL_TRANSLATIONS_DIR']
        )
...
def get_translations():
    ...
    if translations is None:
        dirname = os.path.join(
            ctx.app.root_path,
            ctx.app.config['BABEL_TRANSLATIONS_DIR']
        )
